...
const hotelTags = {
  accommodation: ["Hoteles de lujo", "Ryokan (tradicional)", "Hoteles cápsula", "Hoteles de negocios", "Apartamentos", "Hostales"],
  hotelServices: ["Wi-Fi gratis", "Desayuno incluido", "Aparcamiento gratuito", "Transporte al aeropuerto", "Piscina", "Gimnasio", "Restaurante en el hotel", "Accesible", "Admite mascotas"],
  typeTrip: ["Familiar", "Luna de miel", "De negocios", "Amigable para mochileros", "Para aventureros"],
};

const attractionTags = ["Naturaleza", "Playa", "Monumento", "Gastronomía", "Noche", "Museo", "Cafés", "Shopping", "Ocio", "Festival", "Tecnología", "Juegos", "Anime", "Parques temáticos", "Samurai", "Templo Budista", "Reserva de Aves", "Castillos", "Templo Cristiano", "Templo Sintoísta", "Templo Hindú", "Aguas Termales", "Viñedos"];

const restaurantTags = {
  restaurantTypes: ["Restaurantes tradicionales", "Cadenas de comida rápida", "Cafeterías y cafés", "Restaurantes de alta cocina", "Food trucks", "Ramen", "Sushi"],
  cuisines: ["Cocina japonesa tradicional", "Internacional", "Fusión", "Cocina vegetariana-vegana", "Cocina sin gluten", "Cocina halal", "Cocina kosher", "Rápida", "Cocina de autor", "Con espectáculo", "Familiar", "Romántica", "Negocios", "Ocasiones especiales"],
  restaurantServices: ["Wi-Fi gratis", "Menú en inglés", "Reservas en línea", "Entregas a domicilio", "Terraza o comedor al aire libre", "Opciones de comida para llevar", "Admite mascotas", "Ingredientes orgánicos", "Mariscos frescos", "Menús infantiles"],
};
...
const ExperienceSchema = new Schema(
  {
    ...
    restaurantTags: {
      ...
      restaurantServices: [{ type: String, enum: restaurantTags.restaurantServices }],
    },
