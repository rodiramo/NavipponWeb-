      ...
      ...(mode === "dark"
        ? {
            primary: {
              ...
              light: colorTokens.primary[1000],
        ...
        : {
            ...
            secondary: {
              ...
              lightBlue: colorTokens.lightBlue[300],
            ...
            success: {
              dark: colorTokens.success[700],
              main: colorTokens.success[500],
              medium: colorTokens.success[400],
            ...
            error: {
              ...
              lightest: colorTokens.error[50],
            },
            warning: {
              dark: colorTokens.warning[700],
              main: colorTokens.warning[500],
              light: colorTokens.warning[200],
              lightest: colorTokens.warning[50],
            },
            neutral: {
