...
const CreateItinerary = () => {
  ...
  return (
    <div className="create-itinerary container mx-auto max-w-5xl px-5 py-5 flex flex-col lg:flex-row lg:gap-x-5 lg:items-start">
      <main className="flex-1">
        ...
        <form onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <ul>
                    {board.favorites.map((favorite, favIndex) => (
                      <li key={`${index}-${favorite._id}`} className="flex items-center mb-2">
          ...
          <button type="submit" className="bg-green-500 text-white px-4 py-2 rounded-md">Create Itinerary</button>
        </form>
      </main>
