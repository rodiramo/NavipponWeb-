...
import { ImageUp, Trash2, Earth } from "lucide-react";
import {
  Button,
  Field,
  TextField,
      ...
      <article>
        ...
        <div>
          <Typography variant="subtitle1">
            ...
            <span style={{ color: theme.palette.text.secondary }}>
              (Ingresa el nombre o la dirección de la experiencia que quieras
              agregar para poder cargar la información de forma automática)
            </span>
          </Typography>
          <Autocomplete
            onLoad={handleOnLoad}
        ...
        <div className="d-form-control w-full" style={{ marginTop: "0.5rem" }}>
          <Typography variant="subtitle1">
            Extracto*{" "}
            <span style={{ color: theme.palette.text.secondary }}>
              (Una descripción breve o información importante que se quiera
              destacar de la experiencia ){" "}
            </span>
          </Typography>
          <TextField
